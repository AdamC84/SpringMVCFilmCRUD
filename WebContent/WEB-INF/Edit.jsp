...
<body>
	<form:form action="update.do" method="POST" modelAttribute="film">
		...
		Film Rental Duration:<form:input path="rental duration" value="${film.rental_duration }"/><br> 
		Film Rental Rate:<form:input path="rental rate" value="${film.rental_rate }"/><br>
